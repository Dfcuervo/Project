...
@section('content')
    <div class="card card-primary">
        <div class="card-header"><h4 style="margin-left: 41%">Registrarse</h4></div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="firstName" type="text"
                                   ...
                                   name="name"
                                   tabindex="1" placeholder="Ingresar nombre completo" value="{{ old('name') }}"
                                   autofocus required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="email" type="email"
                                   ...
                                   placeholder="Ingresar Email" name="email" tabindex="1"
                                   value="{{ old('email') }}"
                                   required autofocus>
                            <div class="invalid-feedback">
                                {{ $errors->first('email') }}
